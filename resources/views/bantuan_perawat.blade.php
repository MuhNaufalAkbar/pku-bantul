...
<head>
    ...
    <title>Bantuan Perawat - PKU Bantul</title>
    ...
    <div class="dash-wrapper">
        ...
        <aside class="sidebar">
            ...
            <div class="sidebar-nav">
                ...
                <a href="{{ url('/bantuan_perawat') }}" class="side-link active">
        ...
        <main class="main-content">
            ...
            <div class="faq-card">
                ...
                <div class="faq-item">
                    <button class="faq-question" onclick="toggleFaq(this)">
                        Bagaimana cara melihat data check harian semua pasien?
                        <div class="faq-chevron"><svg width="12" height="12" viewBox="0 0 12 12" fill="none"><path d="M2 4l4 4 4-4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></div>
                    </button>
                    <div class="faq-answer">Buka menu "Data Pasien" di sidebar. Setiap pasien ditampilkan dalam card. Klik "Lihat Detail" untuk memperluas dan melihat seluruh riwayat check harian pasien tersebut. Tersedia juga tombol Print untuk mencetak datanya.</div>
                </div>
                ...
                <div class="faq-item">
                    <button class="faq-question" onclick="toggleFaq(this)">
                        Bagaimana cara memperbarui data profil saya?
                        <div class="faq-chevron"><svg width="12" height="12" viewBox="0 0 12 12" fill="none"><path d="M2 4l4 4 4-4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></div>
                    </button>
                    <div class="faq-answer">Buka halaman Dashboard Perawat, kemudian isi form "Data Pribadi" dengan informasi terbaru Anda. Klik "Simpan Perubahan" untuk menyimpan, atau "Batal" untuk membatalkan perubahan.</div>
                </div>

                <div class="faq-item">
                    <button class="faq-question" onclick="toggleFaq(this)">
                        Bagaimana cara mengidentifikasi pasien yang putus obat?
                        <div class="faq-chevron"><svg width="12" height="12" viewBox="0 0 12 12" fill="none"><path d="M2 4l4 4 4-4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></div>
                    </button>
                    <div class="faq-answer">Pada halaman Data Pasien, stat card "Putus Obat" menampilkan jumlah pasien yang tidak mengisi check harian selama 3 hari berturut-turut. Periksa detail pasien tersebut dan hubungi mereka untuk tindak lanjut segera.</div>
                </div>
            </div>
